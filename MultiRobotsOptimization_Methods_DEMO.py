...
__IniRobotPosX__ = 200
__IniRobotPosY__ = 200
...
__ChangeTaskWhileTravelling__ = [False]
...
__AOtypes__ = [[AOtypes.OWA_OPERATOR, AOtypes.TNORMA_MAX]]
...
__AOparams_PI__ = [[[0.75, 0.15]]] # In case __PhysicalInterference__ is True
